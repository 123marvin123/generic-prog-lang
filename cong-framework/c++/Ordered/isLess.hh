...
struct SpecIsLess {
    static constexpr cong::lang::core::StringStatic name = "isLess";
    ...
    struct Requirement
    {
        ...
        struct Call
        {
            using Type = cong::lang::core::Undefined<"Req for IsLess not specified">;
    ...
    struct GenericImpl
    {
        ...
        struct Call 
        {
            using Type = cong::lang::core::Undefined<"Generic impl for IsLess not specified">;
            static constexpr Type call(...);
        };
    };
