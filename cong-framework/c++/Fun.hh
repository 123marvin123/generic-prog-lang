...
#define CONG_LANG_CORE_FUNSTATICBYMEMBERFUN(Fun_)                                                                      \
    ...
    {                                                                                                                  \
        ...
        struct Call : ::cong::lang::core::Plain::Call<Arg1_>::Type ::Fun_::template Call<Arg1_, ArgS_...>              \
        {                                                                                                              \
        private:                                                                                                       \
            using Base_ =                                                                                              \
                typename ::cong::lang::core::Plain::Call<Arg1_>::Type ::Fun_::template Call<Arg1_, ArgS_...>;          \
                                                                                                                       \
        public:                                                                                                        \
...
#define CONG_LANG_CORE_FUNSTATICBYMEMBER(Fun_, Member_)                                                                \
    ...
    struct FunByFunStatic
    {
        ...
        struct Call
        {
            ...
            static constexpr Type call(ArgS_... argS) { return {}; }
        };
    };
...
#define CONG_LANG_CORE_FUNCTION(Fun_, fun_)                                                                            \
    ...
    typename Fun_::template Call<ExpS_...>::Type fun_(ExpS_&&... expS)                                                 \
    {                                                                                                                  \
        /* @todo dep. on Tuple<>: */                                                                                   \
...
#define CONG_LANG_CORE_LOCAL_LET_PAIR(Name_, Original_) using Name_ = CONG_LANG_CORE_INTERN_UNPAREN(Original_);

#define CONG_LANG_CORE_LOCAL_LET(INIT_, Pair_)                                                                         \
    (CONG_LANG_CORE_INTERN_UNPAREN(INIT_) CONG_LANG_CORE_INTERN_APPLY(CONG_LANG_CORE_LOCAL_LET_PAIR, Pair_))

#define CONG_LANG_CORE_LOCAL_TYPENAME(TYPE_) typename TYPE_

#define CONG_LANG_CORE_LOCAL_TEMPLATE(SEQOFTYPE_)                                                                      \
    template <CONG_LANG_CORE_INTERN_UNPAREN(CONG_LANG_CORE_TRANSFORM(CONG_LANG_CORE_LOCAL_TYPENAME, SEQOFTYPE_))>
...
public:                                                                                                                \
    template <typename Exp_, typename TupleOfExp_>                                                                     \
    struct Call : CallPropagate_<Exp_, TupleOfExp_>::Call_                                                             \
    {                                                                                                                  \
    }
