...
namespace cong::lang {
    ...
    namespace local {
        template <typename Native_ = long int>
        ...
        public:
            ...
            constexpr
            IntegerDynamic(Native native = 0)
            : Base_{native}
            {}
            template <typename Native__, Native__ native__>
            constexpr
            IntegerDynamic(cong::lang::intern::Exp<IntegerStatic<Native__, native__>>)
            : Base_{native__}
            {}
...
#include "../ApplyMember_operator.hh"
        ...
        CONG_LANG_INTERN_APPLYMEMBER((IntegerDynamic<Native_>),
    ...
    using IntegerDynamic = intern::Exp<local::IntegerDynamic<>>;
