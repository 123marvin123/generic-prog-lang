...
public:
  enum {
    ...
    SEMI = 19, AMP = 20, ARROW = 21, COMMA = 22, ASSIGN = 23, PLUS = 24, 
    MINUS = 25, MUL = 26, DIV = 27, MOD = 28, POW = 29, LT = 30, GT = 31, 
    DOUBLE_COLON = 32, OPEN_BINDING = 33, DYNAMIC_ANNOTATOR = 34, REAL = 35, 
    BOOL = 36, INTEGER = 37, STRING = 38, IDENTIFIER = 39, WHITESPACE = 40, 
